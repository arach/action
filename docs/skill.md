...
- changing `drive.begin`, `drive.touch`, `drive.release`, or `drive.status`
- changing supervision presence for driving agents
- changing MCP observe/act lease heartbeats or implicit begin behavior
