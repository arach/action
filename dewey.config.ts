...
export default {
  ...
  agent: {
    criticalContext: [
      ...
      'Drive leases are agent-owned and connection-scoped: lease truth lives in the agent runtime, while Action.app only presents supervision HUD presence.',
    ...
    rules: [
      ...
      { pattern: 'drive', instruction: 'Read docs/api.md drive lease contract and native/engine/CoreSources/ActionDriveLeaseStore.swift before changing lease or presence behavior.' },
